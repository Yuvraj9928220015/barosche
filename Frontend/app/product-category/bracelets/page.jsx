...
const schemaData = [
  ...
  // 1. ItemList schema
  {
    ...
    itemListElement: [
      {
        "@type": "ListItem", position: 1, url: `${SITE_URL}/product-category/bracelets/freyja-diamond-link-bracelet/`,
        item: { "@type": "Product", "@id": `${SITE_URL}/product-category/bracelets/freyja-diamond-link-bracelet/#product`, name: "Freyja Diamond Link Bracelet in 18kt Gold Vermeil", url: `${SITE_URL}/product-category/bracelets/freyja-diamond-link-bracelet/`, image: "https://api.barosche.com/uploads/product-1782451784924-120020543.jpg", category: "Bracelets", material: "18K Gold Vermeil", brand: { "@type": "Brand", name: "Barosche" }, offers: { "@type": "Offer", "@id": `${SITE_URL}/product-category/bracelets/freyja-diamond-link-bracelet/#offer`, url: `${SITE_URL}/product-category/bracelets/freyja-diamond-link-bracelet/`, price: "249.00", priceCurrency: "EUR" } }
      },
    ],
  },
